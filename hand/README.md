...
1. Escribe la fórmula (\Delta C_i(s)=\sum_{k\in U_i}[(1-p^1_{ik})^{s+1}-(1-p^2_{ik})^{s+1}]).
2. Toma (U_i=\{k\}), (p^1_{ik}=0) y (p^2_{ik}=1).
3. Calcula (\Delta C_i(s)=1) para (s=0,1,2).
4. Calcula la primera diferencia y muestra que vale cero, no es estrictamente positiva.
